...
public class OAuth2UserDetailsService {
    ...
    private final MemberDetailRepository memberDetailRepository;  // MemberDetailRepository 추가

    public OAuth2UserDetailsService(MemberRepository memberRepository, SocialRepository socialRepository, MemberDetailRepository memberDetailRepository) {
        this.memberRepository = memberRepository;
        this.socialRepository = socialRepository;
        this.memberDetailRepository = memberDetailRepository;
    }

    public void saveOrUpdateSocialUser(OAuth2User oAuth2User) {
